...
public class MassivesoftCoreClass
{
    ...
    public MongoId playerInventoryId = new MongoId("55d7217a4bdc2d86028b456d");
    ...
    public void AdvancedCreateItemFromClone(AdvancedNewItemFromCloneDetails details)
    {
        ...
        if (details.AddMasteries)
        {
            ...
            else
            {
                ...
                {
                    List<MongoId> newTemplates = new List<MongoId>();
        ...
        {
            ModAddtoSlot(details.NewId, DBItems![playerInventoryId], "FirstPrimaryWeapon");
            ModAddtoSlot(details.NewId, DBItems![playerInventoryId], "SecondPrimaryWeapon");
        }
        if (details.AddToHolsterWeaponSlot)
        {
            ModAddtoSlot(details.NewId, DBItems![playerInventoryId], "Holster");
        }
    ...
    // Merge all items in conflictingInfos'id's target slot to the conflicting items of itemID.
